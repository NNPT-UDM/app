      ...
      <div className="container">
        <div className="row g-3 g-sm-6">
          <div className="col-6 col-lg-4 col-lg-2 col-xl-2">
            <Link to="/category/hare-care" className="product-category-item">
              <img className="icon" src={Category1} width="70" height="80" alt="Image-HasTech" />
          ...
          <div className="col-6 col-lg-4 col-lg-2 col-xl-2 mt-xl-0 mt-sm-6 mt-4">
            ...
            >
              <img className="icon" src={Category5} width="80" height="80" alt="Image-HasTech" />
          ...
          <div className="col-6 col-lg-4 col-lg-2 col-xl-2 mt-xl-0 mt-sm-6 mt-4">
            ...
            >
              <img className="icon" src={Category6} width="80" height="80" alt="Image-HasTech" />
