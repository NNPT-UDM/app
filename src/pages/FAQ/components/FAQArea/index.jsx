...
import FAQHome from "../../../../assets/images/photos/faq-home.webp";
import FAQImg from "../../../../assets/images/photos/faq.webp";
        ...
        <div className="row flex-xl-row-reverse">
          <div className="col-lg-6 col-xl-7">
            <div className="faq-thumb">
              <img src={FAQHome} width={601} height={368} alt="Image" />
            </div>
          </div>
          <div className="col-lg-6 col-xl-5">
            <div className="faq-content">
              <div className="faq-text-img">
                <img src={FAQImg} width={199} height={169} alt="Image" />
              </div>
            ...
            <div className="accordion" id="FaqAccordion">
              <div className="accordion-item">
                <h2 className="accordion-header" id="heading1">
                  ...
                  >
                    Mauris congue euismod purus at semper. Morbi et vulputate
                    massa?
                  </button>
                </h2>
                <div
